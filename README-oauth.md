...
|STIGMAN_CLIENT_EXTRA_SCOPES|Default: none<br>Additional scopes the webapp will request from the OAuth2 provider. Some providers require scope `offline_access` to generate a refresh token.|Client|
