      ...
      const tpl = new Ext.XTemplate(
          ...
          `<div class='sm-home-widget-text'>`,
            `<div class=sm-home-widget-image-text-wrap>`,
              `<img src="${STIGMAN.Env.welcome.image ? STIGMAN.Env.welcome.image : 'img/navy.png'}" style="max-width:100%;max-height:100%;"/>`,
            `</div>`,
            `<b>STIG Manager</b> is an API and Web client for managing the assessment of Information Systems for compliance with <a href="https://public.cyber.mil/stigs/">security checklists</a> published by the United States (U.S.) Defense Information Systems Agency (DISA). STIG Manager supports DISA checklists <a href="https://public.cyber.mil/stigs/downloads/">distributed</a> as either a Security Technical Implementation Guide (STIG) or a Security Requirements Guide (SRG)`,
          `</div>`, 
          `<div class='sm-home-widget-text'>`,
